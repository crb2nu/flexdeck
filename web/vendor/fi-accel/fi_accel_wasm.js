...
const _initResult = await initWasm({ "./fi_accel_wasm_bg.js": wasmBindings });
// Vite's ?init returns exports directly in the main bundle but a
// WebAssembly.Instance in worker bundles. Normalise to the exports shape so
// __wbg_set_wasm receives the right object and __wbindgen_start can be called.
const wasmExports = (_initResult instanceof WebAssembly.Instance)
  ? _initResult.exports
  : _initResult;
